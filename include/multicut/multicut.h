...
struct FMC_MULTICUT {
   ...
   using multicut = multicut_constructor<FMC_MULTICUT,edge_factor_container,triplet_factor_container,edge_triplet_message_0_container,edge_triplet_message_1_container,edge_triplet_message_2_container>;
...
struct FMC_ODD_WHEEL_MULTICUT {
   ...
   using multicut_c = multicut_constructor<FMC_ODD_WHEEL_MULTICUT,edge_factor_container,triplet_factor_container,edge_triplet_message_0_container,edge_triplet_message_1_container,edge_triplet_message_2_container>;
   using multicut_cow = multicut_odd_wheel_constructor<multicut_c, odd_3_wheel_factor_container, triplet_odd_wheel_message_012, triplet_odd_wheel_message_013, triplet_odd_wheel_message_023, triplet_odd_wheel_message_123>;
...
struct FMC_ODD_BICYCLE_WHEEL_MULTICUT {
   ...
   using multicut_c = multicut_constructor<FMC_ODD_BICYCLE_WHEEL_MULTICUT,edge_factor_container,triplet_factor_container,edge_triplet_message_0_container,edge_triplet_message_1_container,edge_triplet_message_2_container>;
   using multicut_cow = multicut_odd_wheel_constructor<multicut_c, odd_3_wheel_factor_container, triplet_odd_wheel_message_012, triplet_odd_wheel_message_013, triplet_odd_wheel_message_023, triplet_odd_wheel_message_123>;
   using multicut_cowobw = multicut_odd_bicycle_wheel_constructor<multicut_cow, odd_bicycle_3_wheel_factor_container, odd_3_wheel_odd_bicycle_wheel_message_0123, odd_3_wheel_odd_bicycle_wheel_message_0124, odd_3_wheel_odd_bicycle_wheel_message_0134, odd_3_wheel_odd_bicycle_wheel_message_0234, odd_3_wheel_odd_bicycle_wheel_message_1234>;
...
struct FMC_LIFTED_MULTICUT {
   ...
   using base_multicut_c = multicut_constructor<FMC_LIFTED_MULTICUT,edge_factor_container,triplet_factor_container,edge_triplet_message_0_container,edge_triplet_message_1_container,edge_triplet_message_2_container>;
   using lifted_multicut_c = class lifted_multicut_constructor<base_multicut_c, cut_factor_container, CutEdgeLiftedMulticutFactorMessageContainer, LiftedEdgeLiftedMulticutFactorMessageContainer>;
   using ProblemDecompositionList = meta::list<lifted_multicut_c>;
...
struct FMC_MULTIWAY_CUT {
   ...
   using multicut_c = multicut_constructor<FMC_MULTIWAY_CUT,0,1, 0,1,2, 3>;
   using multicut_cow = multicut_odd_wheel_constructor<multicut_c,2, 3,4,5,6>;
...
struct FMC_ASYMMETRIC_MULTIWAY_CUT {
   ...
   using multicut_c = multicut_constructor<FMC_ASYMMETRIC_MULTIWAY_CUT,0,1, 0,1,2, 3>;
   using multicut_cow = multicut_odd_wheel_constructor<multicut_c,2, 3,4,5,6>;
...
namespace MulticutOpenGmInput {
   ...
   bool ParseProblemOld(const std::string filename, SOLVER& pd)
   {
      ...
      for(INDEX i=0; i<edges.size(); ++i) {
         ...
         pd.GetLP().add_to_constant(edgeCosts[2*i]);
